...
* [ODiff](https://github.com/dmtrKovalenko/odiff) ⭐ 3,189 | 🐛 15 | 🌐 Zig | 📅 2026-08-24 – Library of [YIQ NTSC transmission image difference alghoritm](http://www.progmat.uaem.mx:8080/artVol2Num2/Articulo3Vol2Num2.pdf) implemented in OCaml and ReasonML.
...
* [Core](https://github.com/janestreet/core) ⭐ 1,319 | 🐛 5 | 🌐 OCaml | 📅 2026-07-10 – Jane Street Capital's full-fledged standard library overlay. A portable subset of Core is also available: [Core\_kernel](https://github.com/janestreet/core_kernel) ⭐ 224 | 🐛 2 | 🌐 OCaml | 📅 2026-07-10.
* [Base](https://github.com/janestreet/base) ⭐ 1,086 | 🐛 9 | 🌐 OCaml | 📅 2026-07-10 - Jane Street Capital's dependency-free, quick-compiling, fully-portable across any environment that can run OCaml code standard library.
...
* [ocaml-containers](https://github.com/c-cube/ocaml-containers) ⭐ 523 | 🐛 21 | 🌐 OCaml | 📅 2026-08-30 – A lightweight, modular standard library extension, string library, and interfaces to various libraries (bigarrays, Unix, etc.) BSD license.
...
* [flow](https://github.com/facebook/flow) ⭐ 22,283 | 🐛 518 | 🌐 Rust | 📅 2026-09-10 - flow is a static type checker for JavaScript.
* [Infer](https://github.com/facebook/infer) ⭐ 15,705 | 🐛 206 | 🌐 OCaml | 📅 2026-09-10 - Infer is a static analyzer for Java, C and Objective-C
...
* [BAP](https://github.com/BinaryAnalysisPlatform/bap) ⭐ 2,255 | 🐛 43 | 🌐 OCaml | 📅 2026-05-07 - BAP is a reverse engineering and program analysis platform that targets binary programs.
...
* [Owi](https://github.com/OCamlPro/owi) ⭐ 322 | 🐛 151 | 🌐 OCaml | 📅 2026-09-09 - Owi is a toolchain for working with WebAssembly (Wasm) in OCaml, featuring a powerful, parallel symbolic execution engine for Wasm. It also provides frontends for compiling and analyzing C and Rust programs.
* [Smt.ml](https://github.com/formalsec/smtml) ⭐ 81 | 🐛 59 | 🌐 OCaml | 📅 2026-09-07 - Smt.ml is a frontend OCaml library that interfaces with multiple SMT solvers, enabling seamless integration of solvers like Z3, cvc5, Colibri2, Bitwuzla, and Alt-Ergo within OCaml programs.
...
* **Libraries**:
  * [Eio](https://github.com/ocaml-multicore/eio) ⭐ 723 | 🐛 60 | 🌐 OCaml | 📅 2026-09-10 — effects-based direct-style IO for multicore OCaml.
  * [Miou](https://github.com/robur-coop/miou) ⭐ 143 | 🐛 10 | 🌐 OCaml | 📅 2026-09-07 — a simple scheduler for OCaml 5.
...
* **New Implementations**
  * [Irmin](https://github.com/mirage/irmin) ⭐ 1,957 | 🐛 147 | 🌐 OCaml | 📅 2026-09-02 — A distributed database that follows the same design principles as Git.
...
* **Overlays**
  * [Caqti](https://github.com/paurkedal/ocaml-caqti) ⭐ 356 | 🐛 10 | 🌐 OCaml | 📅 2026-08-26 - Cooperative-threaded access to relational data
...
* [ocamlformat](https://github.com/ocaml-ppx/ocamlformat) ⭐ 731 | 🐛 135 | 🌐 OCaml | 📅 2026-09-08 - A command-line tool to format OCaml code.
...
* **Editor Integration**:
  * [merlin](https://github.com/ocaml/merlin) ⭐ 1,704 | 🐛 269 | 🌐 OCaml | 📅 2026-09-08 – Context sensitive completion for OCaml in Vim and Emacs.
  * [ocaml-lsp](https://github.com/ocaml/ocaml-lsp) ⭐ 909 | 🐛 128 | 🌐 OCaml | 📅 2026-09-08 - An LSP language server for OCaml that integrates with any editor that understands LSP like [VSCode](https://github.com/microsoft/vscode) ⭐ 191,551 | 🐛 20,791 | 🌐 TypeScript | 📅 2026-09-10, Vim and Emacs.
  ...
  * [OCaml Debugger](https://github.com/hackwaly/ocamlearlybird) ⭐ 236 | 🐛 27 | 🌐 OCaml | 📅 2026-07-20 – extension that provides OCaml Debugger for [VSCode](https://github.com/microsoft/vscode) ⭐ 191,551 | 🐛 20,791 | 🌐 TypeScript | 📅 2026-09-10
  * [vscode-ocaml](https://github.com/hackwaly/vscode-ocaml) ⚠️ Archived – extension that provides OCaml language support for [VSCode](https://github.com/microsoft/vscode) ⭐ 191,551 | 🐛 20,791 | 🌐 TypeScript | 📅 2026-09-10
...
* [99 problems](https://ocaml.org/learn/tutorials/99problems.html). 99% of the solutions are [here](https://github.com/MassD/99) ⭐ 60 | 🐛 0 | 🌐 OCaml | 📅 2022-08-01.
...
* [camlPDF](https://github.com/johnwhitington/camlpdf) ⭐ 230 | 🐛 10 | 🌐 OCaml | 📅 2026-09-10 – OCaml library for reading, writing and modifying PDF files.
...
* [Uucp](https://github.com/dbuenzli/uucp) ⭐ 23 | 🐛 3 | 🌐 OCaml | 📅 2026-08-13 — Unicode character properties for OCaml.
* [Uucd](https://github.com/dbuenzli/uucd) ⭐ 17 | 🐛 0 | 🌐 OCaml | 📅 2026-08-13 — Unicode character database decoder for OCaml.

## User Interface

* [Lambda-Term](https://github.com/ocaml-community/lambda-term) ⭐ 230 | 🐛 23 | 🌐 OCaml | 📅 2026-08-18 – Lambda-Term is a cross-platform library for manipulating the terminal. It provides an abstraction for keys, mouse events, and colors, as well as a set of widgets to write curses-like applications.
* [lablqml](https://github.com/Kakadu/lablqml) ⭐ 165 | 🐛 14 | 🌐 OCaml | 📅 2026-08-08 – QML Qt5 bindings for OCaml.
...
* [coq](https://github.com/coq/coq) ⭐ 5,571 | 🐛 2,524 | 🌐 OCaml | 📅 2026-09-10 - formal proof management system
* [mirage](https://github.com/mirage/mirage) ⭐ 2,986 | 🐛 62 | 🌐 OCaml | 📅 2026-07-28 -  library operating system that constructs unikernels for secure, high-performance network applications across a variety of cloud computing and mobile platforms
* [Liquidsoap](https://github.com/savonet/liquidsoap) ⭐ 1,729 | 🐛 273 | 🌐 OCaml | 📅 2026-09-10 - a swiss-army knife for multimedia streaming, notably used for netradios and webtvs
* [Base](https://github.com/janestreet/base) ⭐ 1,086 | 🐛 9 | 🌐 OCaml | 📅 2026-07-10 - Standard library for OCaml
* [libguestfs](https://github.com/libguestfs/libguestfs) ⭐ 746 | 🐛 55 | 🌐 C | 📅 2026-08-26 - library and tools for accessing and modifying virtual machine disk images
* [cil](https://github.com/cil-project/cil) ⭐ 403 | 🐛 32 | 🌐 OCaml | 📅 2023-09-14 - C Intermediate Language
* [xen-api](https://github.com/xapi-project/xen-api) ⭐ 366 | 🐛 100 | 🌐 OCaml | 📅 2026-09-10 - management stack that configures and controls Xen-enabled hosts and resource pools, and co-ordinates resources within the pool.
* [MLDonkey](https://github.com/ygrek/mldonkey) ⭐ 345 | 🐛 58 | 🌐 OCaml | 📅 2025-01-28 - cross-platform multi-network peer-to-peer daemon
...
* [dolog](https://github.com/UnixJunkie/dolog) ⭐ 37 | 🐛 3 | 🌐 OCaml | 📅 2023-09-14 – A dumb OCaml logger.
...
* **HTTP Tools**:
  * [ocaml-cohttp](https://github.com/mirage/ocaml-cohttp) ⭐ 777 | 🐛 105 | 🌐 OCaml | 📅 2026-09-08 – Very lightweight HTTP server using Lwt or Async.
...
* **Distribution**:
  * [esy](https://github.com/esy/esy) ⭐ 857 | 🐛 329 | 🌐 Reason | 📅 2026-09-09 - package.json workflow for native development with Reason/OCaml.
...
* **Build Tools**:
  * [dune](https://github.com/ocaml/dune) ⭐ 1,915 | 🐛 1,008 | 🌐 OCaml | 📅 2026-09-09 – A composable and opinionated build system for OCaml (former jbuilder)
  ...
  * [Oasis](http://oasis.forge.ocamlcore.org/) - A tool to integrate a configure, build and install system in your OCaml project. It helps to create standard entry points in your build system and allows external tools to analyse your project easily.
    * [oasis2opam](https://github.com/ocaml/oasis2opam) ⭐ 26 | 🐛 7 | 🌐 OCaml | 📅 2017-10-28 — Tool to convert OASIS metadata to OPAM package descriptions.
...
* [**dyn** ](https://github.com/ocaml/dune/blob/4b95cd3d1b3a62e69a9a9db2bc4af2f9fd2e56d8/otherlibs/dyn/dyn.mli) ⭐ 1,915 | 🐛 1,008 | 🌐 OCaml | 📅 2026-09-09 in Dune. It appears to also be fully manual.
...
* [ocaml-tls](https://github.com/mirleft/ocaml-tls) ⭐ 320 | 🐛 6 | 🌐 OCaml | 📅 2026-07-28 – TLS in pure OCaml.
...
* [sexplib](https://github.com/janestreet/sexplib) ⭐ 196 | 🐛 3 | 🌐 OCaml | 📅 2026-07-10 – A S-expression parser and printer
...
* [Mirage OS](https://github.com/mirage/mirage) ⭐ 2,986 | 🐛 62 | 🌐 OCaml | 📅 2026-07-28 – Mirage is a programming framework for constructing secure, high-performance network applications across a variety of cloud computing and mobile platforms.
...
* [Alcotest](https://github.com/mirage/alcotest) ⭐ 513 | 🐛 63 | 🌐 OCaml | 📅 2026-07-20 – A lightweight and colourful test framework.
* [QCheck](https://github.com/c-cube/qcheck) ⭐ 406 | 🐛 50 | 🌐 OCaml | 📅 2026-08-30 — QCheck is a property testing library inspired from Haskell's QuickCheck
...
* **Frameworks**:
  * [Opium](https://github.com/rgrinberg/opium) ⭐ 782 | 🐛 33 | 🌐 OCaml | 📅 2026-01-06 – Sinatra like web toolkit for OCaml.
...
* **Tools**:
  ...
  * [Goji](https://github.com/klakplok/goji) ⭐ 43 | 🐛 2 | 🌐 OCaml | 📅 2014-07-26 – An OCaml bindings generator for JavaScript libraries.
...
*Inspired by awesome projects line. Discover [more awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,662 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02 :sparkles:.*
